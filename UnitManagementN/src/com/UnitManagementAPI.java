...
/**
 * Servlet implementation class UnitManagementAPI
 */
@WebServlet("/UnitManagementAPI")
public class UnitManagementAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = unitObj.insertUnit(
				request.getParameter("uID"),
				request.getParameter("uAccNo"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = unitObj.updateUnit(paras.get("hideUnitManagementIDSave").toString(),
